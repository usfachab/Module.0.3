...
/*   main.cpp                                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: usfachab <usfachab@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/29 00:04:35 by yachaab           #+#    #+#             */
/*   Updated: 2023/10/06 20:38:43 by usfachab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
    ...
    // std::cout << scav.getHealthPoints() << std::endl;
    // std::cout << sc.getHealthPoints() << std::endl;
